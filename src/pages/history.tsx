...
export default function HistoryPage() {
    ...
    return (
        <Layout title="Riwayat Pemesanan - BorneoTrip">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-sm">Kelola semua perjalanan dan transaksi Anda.</p>
                        </div>
                    </div>
                        ...
                        {filteredBookings.length > 0 ? (
                            filteredBookings.map((booking, idx) => (
                                <motion.div
                                    ...
                                    className="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow group"
                                >
                            ...
                            <div className="text-center py-20">
                                ...
                                <p className="text-gray-500 mb-6">Mulai petualangan Anda sekarang!</p>
