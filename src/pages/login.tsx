...
export default function LoginPage() {
    ...
    return (
        <>
            <Head>
                <title>{`${view === 'login' ? 'Masuk' : 'Lupa Password'} - BorneoTrip`}</title>
            ...
            <div className="min-h-screen flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
                ...
                >
                    <div className="text-center mb-8">
                        ...
                        <p className="text-emerald-100/80 text-lg font-medium">Gerbang Menuju Surga Kalimantan</p>
                    </div>
                            ...
                            {view === 'login' ? (
                                        ...
                                        {activeTab === 'staff' && (
                                            <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex items-start gap-3">
                                                ...
                                                <div className="text-xs text-blue-800">
                                                    <p className="font-bold mb-1">Demo Access Available:</p>
                                        ...
                                        {activeTab === 'client' && (
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="ml-3 text-sm font-medium text-gray-700 cursor-pointer" onClick={() => setRememberMe(!rememberMe)}>Ingat Saya</span>
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            >
                                                {isLoading ? (
                                                    ...
                                                    <>
                                                        {activeTab === 'staff' ? 'Masuk ke Dashboard' : 'Mulai Petualangan'} <ArrowRight className="w-4 h-4" />
                                                    </>
                                                )}
                                            </button>
                                        </div>
                                ...
                                >
                                    {socialLoading ? (
                                        <div className="flex flex-col items-center justify-center py-12">
                                            ...
                                            <p className="text-gray-500 font-medium animate-pulse">Menghubungkan ke {socialProvider === 'google' ? 'Google' : 'Facebook'}...</p>
                                        </div>
                                    ) : (
                                        <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-xl">
                                            ...
                                            <div className="p-6">
                                                <p className="text-gray-600 mb-6 font-medium">
                                                    {socialProvider === 'google' 
                                                        ? 'Pilih akun untuk melanjutkan ke BorneoTrip' 
                                                        : 'Lanjutkan sebagai Dian? BorneoTrip akan menerima profil publik dan email Anda.'}
                                                </p>
                                ...
                                >
                                    ...
                                    <div className="text-center mb-6">
                                        ...
                                        <p className="text-gray-500 mt-2 text-sm">Masukkan email Anda untuk menerima instruksi reset password.</p>
                                    </div>
                                    ...
                                    {!isResetSent ? (
                                        ...
                                        >
                                            ...
                                            <h3 className="font-bold text-green-800 text-lg mb-2">Email Terkirim!</h3>
                                            <p className="text-green-700 text-sm mb-4">
                                                Cek email <span className="font-bold">{resetEmail}</span> untuk instruksi selanjutnya.
                                            </p>
                                            <button 
                                                onClick={() => {
