...
export default function EventDetail() {
            ...
            <Layout>
                <div className="min-h-screen flex items-center justify-center">
                    <div className="text-center">
                        ...
                        <Link href="/events" className="text-emerald-600 hover:underline">Kembali ke Event</Link>
                    </div>
                </div>
            </Layout>
        );
    ...
    const handleShare = () => {
        ...
        addToast("Link event berhasil disalin!", "success");
    };
            ...
            <div className="relative h-[85vh] w-full overflow-hidden bg-black">
                ...
                <div className="absolute top-0 left-0 p-6 z-20">
                    <Link href="/events" className="inline-flex items-center gap-2 text-white/80 hover:text-white transition bg-black/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 group">
                        <ArrowLeft className="w-5 h-5 group-hover:-translate-x-1 transition" /> Kembali
                    </Link>
                </div>
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-12 text-lg text-gray-200">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-xs text-gray-400 uppercase tracking-wider font-bold">Tanggal</p>
                            ...
                            {event.organizer && (
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-gray-400 uppercase tracking-wider font-bold">Organizer</p>
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        >
                            ...
                            <div className="mt-8 flex flex-wrap gap-2">
                                {event.tags.map(tag => (
                                    <span key={tag} className="px-4 py-1.5 bg-gray-100 text-gray-600 rounded-full text-sm font-medium hover:bg-emerald-50 hover:text-emerald-700 transition cursor-default">
                                        #{tag}
                                    </span>
                                ))}
                            </div>
                        ...
                        {event.schedule && (
                            ...
                            >
                                <h2 className="text-2xl font-bold text-gray-900 mb-8 flex items-center gap-2">
                                    <Clock className="w-6 h-6 text-emerald-600" /> Rundown Acara
                                </h2>
                        ...
                        {event.gallery && (
                            ...
                            >
                                <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                                    <Mic2 className="w-6 h-6 text-purple-600" /> Highlights Previous Year
                                </h2>
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-24 space-y-6">
                            <motion.div
                                ...
                                className="bg-white p-8 rounded-3xl shadow-2xl shadow-emerald-900/10 border border-gray-100"
                            >
                                <div className="mb-8 text-center">
                                    <p className="text-gray-500 font-bold uppercase tracking-widest text-xs mb-2">Harga Tiket Mulai</p>
                                    <div className="text-4xl font-black text-gray-900">
                                        {event.price || 'Free'}
                                    </div>
                                    {event.ticketCount && (
                                        <p className="text-sm text-emerald-600 font-medium mt-2 bg-emerald-50 inline-block px-3 py-1 rounded-full">
                                            {event.ticketCount} Tiket Tersedia
                                        </p>
                                    )}
                                </div>
                            ...
                            <div className="bg-gradient-to-br from-emerald-800 to-teal-900 rounded-3xl p-8 text-white shadow-lg overflow-hidden relative">
                                <div className="relative z-10">
                                    <Heart className="w-8 h-8 mb-4 text-emerald-300" />
                                    <h3 className="text-xl font-bold mb-2">Tertarik menjadi Sponsor?</h3>
                                    <p className="text-emerald-100/80 text-sm mb-6">Dukung event lokal dan ekspos brand Anda ke ribuan pengunjung.</p>
                                    <Link href="/contact" className="text-white font-bold underline decoration-emerald-400 underline-offset-4 hover:text-emerald-300">Hubungi Kami &rarr;</Link>
                                </div>
