    ...
    <section className="py-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative -mx-4 sm:mx-0">
           <div 
             ref={scrollRef}
             className="flex overflow-x-auto gap-6 pb-8 px-4 sm:px-1 snap-x scroll-smooth hide-scrollbar"
             style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
           >
             {items.map((event) => (
                <div key={event.id} className="min-w-[300px] md:min-w-[360px] snap-center">
